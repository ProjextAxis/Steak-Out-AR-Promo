...
assert.match(indexHtml, /marker\.html\?embedded=1&amp;v=20260823-devmode/, 'parent iframe carries the new immutable cache token');
...
assert.match(diagnosticsSource, /const ALWAYS_ON = true;/,
  'TESTING MODE: HUD always on. Flip to false before customers see this.');
