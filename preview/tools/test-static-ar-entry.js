...
assert.match(indexHtml, /marker\.html\?embedded=1&amp;v=20260827-killsplash/, 'parent iframe carries the new immutable cache token');
...
assert.match(diagnosticsSource, /const ALWAYS_ON = false;/,
  'customer default: diagnostics HUD is opt-in (?ar-debug=1 / ?dev=1)');
